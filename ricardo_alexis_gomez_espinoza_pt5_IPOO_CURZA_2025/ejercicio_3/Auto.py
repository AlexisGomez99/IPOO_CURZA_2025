...
class Auto(Transporte, Combustible):
    ...
    def cargar_combustible(self, litros):
        if litros > 0:
            ...
            print(f"Auto: Se cargaron {litros}L. Total disponible: {self._litros_disponibles}L.")
    ...
    def mover(self, distancia):
        ...
        if litros_necesarios <= self._litros_disponibles:
            ...
            print(f"Auto: Recorrido de {distancia}km completado. Consumo: {litros_necesarios}L. Combustible restante: {self._litros_disponibles}L.")
            return True
        else:
            print(f"Auto: No se puede completar el recorrido de {distancia}km. Faltan {(litros_necesarios - self._litros_disponibles)}L de combustible.")
            return False
